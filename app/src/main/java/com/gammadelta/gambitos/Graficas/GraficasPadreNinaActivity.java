...
public class GraficasPadreNinaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graficas_padre_nina);
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if (firebaseAuth.getCurrentUser() != null){
                    ...
                    startActivity(new Intent(GraficasPadreNinaActivity.this, InicioPadresActivity.class));
                    finish();
                }
            }
        };
