...
public class GraficasPadreNinoActivity extends AppCompatActivity {
    private static final String USUARIO_NODE = "Usuarios";
    private static final String PADRE_NODE = "Padres";
    private static final String TAG = "GraficasPadreNina";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graficas_padre_nino);

        menuAtras           = (ImageView)   findViewById(R.id.menu_atras);
        ...
        menuAtras.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if (firebaseAuth.getCurrentUser() != null){
                    ...
                    startActivity(new Intent(GraficasPadreNinoActivity.this, InicioPadresActivity.class));
                    finish();
                }
            }
        };
